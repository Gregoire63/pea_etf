...
export type BrokerType = "courtier" | "banque_en_ligne" | "neocourtier" | "gestion_pilotee" | "banque_traditionnelle";
...
export const PEA_BROKERS: PeaBroker[] = [
  ...
  // ── Hello Bank! (BNP Paribas en ligne) ────────────────────────────────────
  {
    id: "hello-bank",
    name: "Hello Bank!",
    type: "banque_en_ligne",
    feeModel: { type: "tiered", tiers: [{ upTo: 500, fee: 1.75 }, { upTo: 2000, fee: 5 }], aboveRate: 0.005 },
    feeShortLabel: "1,75 € (< 500 €)",
    effectiveMinOrder: 50,
    website: "https://www.hellobank.fr",
    peaUrl: "https://www.hellobank.fr/placements/bourse/pea",
    tariffUrl: "https://www.hellobank.fr/placements/bourse/tarifs",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: FREE,
      orderEuronext: { min: 1.75, max: 5, unit: "EUR", detail: "Start : 1,75 € ≤ 500 €, 5 € ≤ 2 000 €, 0,50 % au-delà" },
      orderOtherEU: { min: 0.25, max: 0.50, unit: "%", detail: "0,25 % à 0,50 % selon place" },
      inactivity: FREE,
      transferOut: { min: 15, max: 15, unit: "EUR", detail: "15 € par ligne" },
      managementFee: null,
      currencyFee: null,
    ...
    pros: [
      "Banque en ligne complète adossée à BNP Paribas",
      "Frais compétitifs pour une banque (1,75 € < 500 €)",
      "PEA Jeune et PEA-PME disponibles",
      "Pas de frais de garde ni d'inactivité",
      "Transfert entrant possible",
    ],
    cons: [
      "Moins compétitif que les néo-courtiers (Trade Republic, XTB)",
      "Offre ETF plus limitée que les courtiers spécialisés",
      "Pas de fractions d'actions",
      "Pas de plans d'investissement programmés gratuits",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.hellobank.fr/placements/bourse/pea",
      "https://www.hellobank.fr/placements/bourse/tarifs",
      "https://avenuedesinvestisseurs.fr/avis-hello-bank-bourse-pea/",
    ],
    managedOption: null,
  },

  // ── Monabanq (Crédit Mutuel Alliance Fédérale) ────────────────────────────
  {
    id: "monabanq",
    name: "Monabanq",
    type: "banque_en_ligne",
    feeModel: { type: "tiered", tiers: [{ upTo: 1000, fee: 5.50 }], aboveRate: 0.005 },
    feeShortLabel: "5,50 € (< 1 000 €)",
    effectiveMinOrder: 100,
    website: "https://www.monabanq.com",
    peaUrl: "https://www.monabanq.com/fr/placements-bourse/pea",
    tariffUrl: "https://www.monabanq.com/fr/placements-bourse/tarifs-bourse",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: FREE,
      orderEuronext: { min: 5.50, max: 0.50, unit: "%", detail: "5,50 € ≤ 1 000 €, 0,50 % au-delà" },
      orderOtherEU: { min: 0.50, max: 0.50, unit: "%", detail: "0,50 % min 15 €" },
      inactivity: FREE,
      transferOut: { min: 15, max: 15, unit: "EUR", detail: "15 € par ligne" },
      managementFee: null,
      currencyFee: null,
    ...
    pros: [
      "Banque en ligne du groupe Crédit Mutuel — solidité bancaire",
      "Pas de frais de garde ni d'inactivité",
      "PEA-PME disponible",
      "Interface simple et service client réactif",
    ],
    cons: [
      "Frais de courtage élevés (5,50 € min)",
      "Offre ETF limitée (~300 ETF)",
      "Pas de PEA Jeune",
      "Moins compétitif que les courtiers en ligne spécialisés",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.monabanq.com/fr/placements-bourse/pea",
      "https://www.monabanq.com/fr/placements-bourse/tarifs-bourse",
    ],
    managedOption: null,
  },
  ...
  // ── Crédit Agricole (Investore) ───────────────────────────────────────────
  {
    ...
    feeModel: { type: "percentage", rate: 0.0065, min: 8 },
    feeShortLabel: "0,65 % (min 8 €)",
    effectiveMinOrder: 100,
    website: "https://www.credit-agricole.fr",
    peaUrl: "https://www.credit-agricole.fr/particulier/epargne/bourse-investissements/pea.html",
    tariffUrl: "https://www.credit-agricole.fr/particulier/epargne/bourse-investissements/tarifs.html",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: { min: 0.24, max: 0.36, unit: "%", detail: "0,24 % à 0,36 %/an selon Caisse Régionale, min ~10 €" },
      orderEuronext: { min: 8, max: 12, unit: "EUR", detail: "0,65 % par ordre en ligne (min 8 €), en agence : ~12 € min" },
      orderOtherEU: { min: 0.50, max: 0.80, unit: "%", detail: "0,50 % à 0,80 % selon place" },
      inactivity: FREE,
      transferOut: { min: 15, max: 50, unit: "EUR", detail: "15 € à 50 € par ligne selon Caisse Régionale" },
      managementFee: null,
      currencyFee: null,
    },
    features: {
    ...
    pros: [
      "Réseau d'agences le plus étendu de France",
      "PEA Jeune et PEA-PME disponibles",
      "Solidité et fiabilité du groupe Crédit Agricole",
      "Accompagnement en agence pour les débutants",
      "Gestion sous mandat disponible via Amundi",
    ],
    cons: [
      "Frais de courtage élevés (0,65 % min 8 €)",
      "Droits de garde annuels (0,24-0,36 %)",
      "Tarifs variables selon la Caisse Régionale",
      "Interface en ligne datée",
      "Pas compétitif pour le DCA régulier",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.credit-agricole.fr/particulier/epargne/bourse-investissements/pea.html",
      "https://www.francetransactions.com/bourse/pea/pea-credit-agricole.html",
    ],
    managedOption: {
      gestionnaire: "Amundi",
      feeType: "fixed",
      annualFee: { min: 1.50, max: 2.50, unit: "%", detail: "1,50 % à 2,50 %/an selon profil (frais de gestion + OPCVM)" },
      performanceFee: null,
      profiles: [
        { name: "Prudent", risk: 3, minHorizon: 3, perf2024: null, perf2025: null },
        { name: "Équilibré", risk: 4, minHorizon: 5, perf2024: null, perf2025: null },
      ...
      minInvestment: 5000,
      canMixWithLibre: false,
      detail: "Gestion sous mandat PEA par Amundi via la Caisse Régionale. Frais variables selon profil et montant.",
    },
  },
  ...
  // ── BNP Paribas ───────────────────────────────────────────────────────────
  {
    ...
    name: "BNP Paribas",
    type: "banque_traditionnelle",
    feeModel: { type: "tiered", tiers: [{ upTo: 1000, fee: 5.50 }, { upTo: 3000, fee: 11 }], aboveRate: 0.004 },
    feeShortLabel: "5,50 € (< 1 000 €)",
    effectiveMinOrder: 100,
    website: "https://mabanque.bnpparibas",
    peaUrl: "https://mabanque.bnpparibas/fr/gerer/epargne/pea",
    tariffUrl: "https://mabanque.bnpparibas/fr/gerer/epargne/bourse/tarifs",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: { min: 0.024, max: 0.024, unit: "%", detail: "0,024 %/mois (0,29 %/an) sur encours, min 5,95 €/an" },
      orderEuronext: { min: 5.50, max: 11, unit: "EUR", detail: "5,50 € ≤ 1 000 €, 11 € ≤ 3 000 €, 0,40 % au-delà (en ligne)" },
      orderOtherEU: { min: 0.50, max: 0.50, unit: "%", detail: "0,50 % min 18 €" },
      inactivity: FREE,
      transferOut: { min: 15, max: 15, unit: "EUR", detail: "15 € par ligne, max 150 €" },
      managementFee: null,
      currencyFee: null,
    ...
    pros: [
      "Grande banque française — solidité et réseau d'agences étendu",
      "PEA Jeune et PEA-PME disponibles",
    ...
    cons: [
      "Frais de courtage élevés (5,50 € min)",
      "Droits de garde annuels (0,29 %/an)",
      "Offre ETF limitée",
      "Interface bourse datée",
      "Pas compétitif face aux courtiers en ligne",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://mabanque.bnpparibas/fr/gerer/epargne/pea",
  ...
  // ── Société Générale ──────────────────────────────────────────────────────
  {
    ...
    type: "banque_traditionnelle",
    feeModel: { type: "percentage", rate: 0.005, min: 8.50 },
    feeShortLabel: "0,50 % (min 8,50 €)",
    effectiveMinOrder: 100,
    website: "https://www.societegenerale.fr",
    peaUrl: "https://www.societegenerale.fr/particuliers/epargner/investir-en-bourse/pea",
    tariffUrl: "https://www.societegenerale.fr/particuliers/epargner/investir-en-bourse/tarifs",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: { min: 0.30, max: 0.30, unit: "%", detail: "0,30 %/an sur encours (droits de garde)" },
      orderEuronext: { min: 8.50, max: 8.50, unit: "EUR", detail: "0,50 % par ordre en ligne, minimum 8,50 €" },
      orderOtherEU: { min: 0.50, max: 0.50, unit: "%", detail: "0,50 % min 18 €" },
      inactivity: FREE,
      transferOut: { min: 15, max: 15, unit: "EUR", detail: "15 € par ligne" },
      managementFee: null,
    ...
    pros: [
      "Grande banque française avec réseau d'agences",
      "PEA Jeune et PEA-PME disponibles",
      "Solidité institutionnelle",
      "Accompagnement conseil en agence",
    ],
    cons: [
      "Frais de courtage élevés (0,50 % min 8,50 €)",
      "Droits de garde annuels (0,30 %)",
      "Offre ETF limitée",
      "Interface bourse basique",
      "Beaucoup plus cher que les courtiers en ligne",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.societegenerale.fr/particuliers/epargner/investir-en-bourse/pea",
  ...
  // ── LCL ────────────────────────────────────────────────────────────────────
  {
    ...
    feeShortLabel: "0,50 % (min 5 €)",
    effectiveMinOrder: 100,
    website: "https://www.lcl.fr",
    peaUrl: "https://www.lcl.fr/epargne/bourse/pea",
    tariffUrl: "https://www.lcl.fr/epargne/bourse/tarifs-bourse",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: { min: 0.20, max: 0.20, unit: "%", detail: "0,20 %/an sur encours titres, min 25 €/an" },
      orderEuronext: { min: 5, max: 5, unit: "EUR", detail: "0,50 % par ordre en ligne, minimum 5 €" },
      orderOtherEU: { min: 0.50, max: 0.50, unit: "%", detail: "0,50 % min 15 €" },
      inactivity: FREE,
      transferOut: { min: 15, max: 15, unit: "EUR", detail: "15 € par ligne" },
      managementFee: null,
    ...
    pros: [
      "Filiale du Crédit Agricole — solidité du groupe",
      "PEA Jeune et PEA-PME disponibles",
      "Frais parmi les plus bas des banques traditionnelles",
      "Transfert entrant possible",
    ],
    cons: [
      "Frais de courtage élevés vs courtiers en ligne (0,50 % min 5 €)",
      "Droits de garde annuels (0,20 %)",
      "Offre ETF limitée",
      "Interface bourse datée",
    ],
    promotions: [],
    ...
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.lcl.fr/epargne/bourse/pea",
  ...
  // ── Crédit Mutuel / CIC ───────────────────────────────────────────────────
  {
    ...
    type: "banque_traditionnelle",
    feeModel: { type: "tiered", tiers: [{ upTo: 1000, fee: 4.95 }], aboveRate: 0.005 },
    feeShortLabel: "4,95 € (< 1 000 €)",
    effectiveMinOrder: 100,
    website: "https://www.creditmutuel.fr",
    peaUrl: "https://www.creditmutuel.fr/fr/particuliers/epargne/pea.html",
    tariffUrl: "https://www.creditmutuel.fr/fr/particuliers/epargne/bourse-tarifs.html",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: { min: 0.20, max: 0.20, unit: "%", detail: "0,20 %/an droits de garde, min ~15 €/an" },
      orderEuronext: { min: 4.95, max: 4.95, unit: "EUR", detail: "4,95 € ≤ 1 000 €, 0,50 % au-delà (tarif en ligne)" },
      orderOtherEU: { min: 0.50, max: 0.50, unit: "%", detail: "0,50 % min 15 €" },
      inactivity: FREE,
      transferOut: { min: 15, max: 15, unit: "EUR", detail: "15 € par ligne" },
      managementFee: null,
    ...
    pros: [
      "Réseau d'agences dense (Crédit Mutuel + CIC)",
      "Frais parmi les plus compétitifs des banques traditionnelles",
      "PEA Jeune et PEA-PME disponibles",
      "Accompagnement en agence",
    ],
    cons: [
      "Droits de garde annuels (0,20 %)",
      "Frais de courtage plus élevés que les courtiers en ligne",
      "Interface bourse moins ergonomique que les néo-courtiers",
      "Offre ETF limitée",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.creditmutuel.fr/fr/particuliers/epargne/pea.html",
  ...
  // ── Caisse d'Épargne ──────────────────────────────────────────────────────
  {
    ...
    type: "banque_traditionnelle",
    feeModel: { type: "percentage", rate: 0.005, min: 6 },
    feeShortLabel: "0,50 % (min 6 €)",
    effectiveMinOrder: 100,
    website: "https://www.caisse-epargne.fr",
    peaUrl: "https://www.caisse-epargne.fr/particuliers/epargne/pea/",
    tariffUrl: "https://www.caisse-epargne.fr/particuliers/epargne/bourse/tarifs/",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: { min: 0.25, max: 0.25, unit: "%", detail: "0,25 %/an droits de garde sur encours titres" },
      orderEuronext: { min: 6, max: 6, unit: "EUR", detail: "0,50 % par ordre en ligne via Direct Écureuil Bourse, min 6 €" },
      orderOtherEU: { min: 0.60, max: 0.60, unit: "%", detail: "0,60 % min 18 €" },
      inactivity: FREE,
      transferOut: { min: 15, max: 50, unit: "EUR", detail: "15 € à 50 € par ligne selon région" },
      managementFee: null,
      currencyFee: null,
    },
    features: {
    ...
    pros: [
      "Réseau d'agences étendu (groupe BPCE)",
      "PEA Jeune et PEA-PME disponibles",
      "Solidité du groupe BPCE (2e groupe bancaire français)",
      "Service Direct Écureuil Bourse pour passer ordres en ligne",
    ],
    cons: [
      "Droits de garde annuels (0,25 %)",
      "Frais de courtage élevés (0,50 % min 6 €)",
      "Offre ETF limitée (~300)",
      "Interface en ligne datée",
      "Tarifs variables selon la caisse régionale",
    ],
    promotions: [],
    ...
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.caisse-epargne.fr/particuliers/epargne/pea/",
  ...
  // ── Banque Populaire ──────────────────────────────────────────────────────
  {
    ...
    type: "banque_traditionnelle",
    feeModel: { type: "percentage", rate: 0.005, min: 7 },
    feeShortLabel: "0,50 % (min 7 €)",
    effectiveMinOrder: 100,
    website: "https://www.banquepopulaire.fr",
    peaUrl: "https://www.banquepopulaire.fr/particuliers/epargne/pea/",
    tariffUrl: "https://www.banquepopulaire.fr/particuliers/epargne/bourse/tarifs/",
    country: "France",
    regulator: "AMF / ACPR",
    fees: {
      opening: FREE,
      custody: { min: 0.25, max: 0.25, unit: "%", detail: "0,25 %/an droits de garde sur encours titres" },
      orderEuronext: { min: 7, max: 7, unit: "EUR", detail: "0,50 % par ordre en ligne, minimum 7 €" },
      orderOtherEU: { min: 0.60, max: 0.60, unit: "%", detail: "0,60 % min 18 €" },
      inactivity: FREE,
      transferOut: { min: 15, max: 50, unit: "EUR", detail: "15 € à 50 € par ligne" },
      managementFee: null,
      currencyFee: null,
    },
    features: {
    ...
    pros: [
      "Réseau d'agences (groupe BPCE, même groupe que Caisse d'Épargne)",
      "PEA Jeune et PEA-PME disponibles",
      "Accompagnement personnalisé en agence",
    ],
    cons: [
      "Droits de garde annuels (0,25 %)",
      "Frais de courtage élevés (0,50 % min 7 €)",
      "Offre ETF limitée",
      "Beaucoup plus cher que les courtiers en ligne",
      "Tarifs variables selon la banque régionale",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.banquepopulaire.fr/particuliers/epargne/pea/",
      "https://www.francetransactions.com/bourse/pea/pea-banque-populaire.html",
    ],
    managedOption: null,
  },

  // ── Goodvest (gestion pilotée ISR) ────────────────────────────────────────
  {
    id: "goodvest",
    name: "Goodvest",
    type: "gestion_pilotee",
    ...
    peaUrl: "https://www.goodvest.fr/pea",
    tariffUrl: "https://www.goodvest.fr/tarifs",
    country: "France",
    regulator: "AMF",
    fees: {
      opening: FREE,
      ...
      inactivity: FREE,
      transferOut: FREE,
      managementFee: { min: 1.60, max: 1.90, unit: "%", detail: "1,60 % à 1,90 %/an tout compris (gestion + frais ETF)" },
      currencyFee: null,
    },
    features: {
      stockCount: null,
    ...
    pros: [
      "Investissement 100 % ISR — PEA aligné sur l'Accord de Paris",
      "Gestion pilotée par des experts (portefeuille ETF durable)",
      "Pas de frais cachés, tout compris",
      "Label B Corp et engagement environnemental",
      "Transfert entrant gratuit",
    ],
    cons: [
      "Pas de gestion libre (choix de titres limité)",
      "Frais plus élevés que la gestion libre (1,60-1,90 %/an)",
      "Univers d'investissement restreint (ISR uniquement)",
      "Pas de PEA Jeune ni PEA-PME",
      "Offre récente, moins de recul que Yomoni",
    ],
    promotions: [],
    lastChecked: "2026-03-04",
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.goodvest.fr/pea",
      "https://www.goodvest.fr/tarifs",
      "https://avenuedesinvestisseurs.fr/avis-goodvest-investissement-responsable/",
    ],
    managedOption: null,
  },

  // ── Nalo (gestion pilotée / gestion sous mandat) ──────────────────────────
  {
    id: "nalo",
    name: "Nalo",
    type: "gestion_pilotee",
    feeModel: { type: "free" },
    feeShortLabel: "Gestion pilotée 1,65 %/an",
    effectiveMinOrder: 0,
    website: "https://www.nalo.fr",
    peaUrl: "https://www.nalo.fr/pea",
    tariffUrl: "https://www.nalo.fr/tarifs",
    country: "France",
    regulator: "AMF",
    fees: {
      opening: FREE,
      ...
      inactivity: FREE,
      transferOut: FREE,
      managementFee: { min: 1.55, max: 1.65, unit: "%", detail: "1,55 % à 1,65 %/an tout compris (mandat + frais ETF)" },
      currencyFee: null,
    },
    features: {
      stockCount: null,
    ...
    pros: [
      "Gestion sous mandat personnalisée par objectif de vie",
      "Portefeuille multi-projets (épargne, retraite, immobilier…)",
      "Algorithme d'allocation sécurisée progressive",
      "Frais transparents et tout compris",
      "Transfert entrant gratuit",
    ],
    cons: [
      "Pas de gestion libre",
      "Frais annuels (1,55-1,65 %) supérieurs à la gestion libre",
      "PEA lancé plus récemment, moins de recul",
      "Pas de PEA Jeune ni PEA-PME",
      "Minimum 1 000 € pour ouvrir",
    ],
    promotions: [],
    ...
    envelopes: ["pea", "cto"],
    sources: [
      "https://www.nalo.fr/pea",
      "https://www.nalo.fr/tarifs",
...
export const BROKER_TYPE_LABELS: Record<BrokerType, string> = {
  ...
  banque_traditionnelle: "Banque traditionnelle",
};
